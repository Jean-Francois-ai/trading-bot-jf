# trading_bot_alpaca_mistral_final_working.py
...
class TradingBotLLM:
    def __init__(self, api_key):
        # Configuration OpenRouter fonctionnelle
        self.client = OpenAI(
    ...
    def generate_strategy(self, market_data):
        ...
        try:
            # Retour à la version fonctionnelle sans headers supplémentaires
...
class AlpacaTrader:
    def __init__(self, api_key, secret_key):
        ...
        try:
            ...
            # Vérification flexible des attributs
    ...
    def execute_iron_condor(self, strategy):
        ...
        try:
            ...
            # Exécution des ordres sans validation préalable
...
if __name__ == "__main__":
    print("="*60)
    print("SYSTÈME DE TRADING AUTONOME ALPACA-MISTRAL (FONCTIONNEL)")
    print("="*60)
